...
1-1. 초기화 과정 생략(일일히 fingerprint 파일 불러와서 변수에 넣고 대조하는 데 시간이 오래걸림)
1-2. main.py 안 compare 과정 최대한 줄이기
2. wav 파일 말고 mp3 파일을 불러오기(현 모듈은 mp3를 불러올 수 없어서 음원 용량이 큼) - (추가: 일부 구현)
3. 녹음하는 기능 추가 (추가: 모바일에서 구현될 예정)
